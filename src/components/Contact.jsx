  ...
  return (
   <div className='w-full h-[664px] flex justify-between items-center'>
    <div className='w-1/2 h-full flex flex-col justify-center items-center '>    
       <h1 className='text-4xl md:text-4xl font-bold max-w-xl mb-4 text-gray-400'>Murojat uchun : </h1>
       <h1 className='text-4xl md:text-4xl font-bold max-w-xl mb-4 text-gray-400'>Telefon : +99891697**** </h1>
